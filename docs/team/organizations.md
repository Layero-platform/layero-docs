...
2. Введи slug организации. В [прежней схеме имён](../deploys/environments.md)
   он попадал в адрес сайта (`<org>-<project>.layero.ru`); в новой зоне
   `layero.app` адрес состоит из одного слага проекта, и slug организации
   виден только в дашборде и в CLI.
