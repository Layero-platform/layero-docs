...
Правка списка применяется за секунды: отказ по устаревшему кешу шлюз
перепроверяет свежим списком, а не отдаёт из кеша. Отсюда и потолок —
несколько секунд, а не минута ожидания, как было раньше.
