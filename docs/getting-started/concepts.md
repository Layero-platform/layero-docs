...
платформы канонический адрес: `https://<project>.layero.app` в новой зоне
пользовательских сайтов либо `https://<organization>-<project>.layero.ru` в
прежней схеме. Какая схема действует для вашей организации — видно в дашборде;
переход идёт волнами, подробности в
[Окружения, preview и production](../deploys/environments.md).
...
организация со slug'ом, равным username. В прежней схеме имён slug
организации попадал в адрес сайта (`https://alice-<project>.layero.ru`); в
новой зоне `layero.app` адрес состоит из одного слага проекта, и slug
организации на него больше не влияет.
